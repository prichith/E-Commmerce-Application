        ...
        <ul>
          <li>
            <div className="cartListImg">
              <img src="https://rukminim1.flixcart.com/flap/64/64/image/22fddf3c7da4c4f4.png?q=100" alt="Redmi10"/>
              <span className="productQuantity"><span className="increment" onClick={decrement}>-</span><span className="quantity">{cartCount}</span><span className="increment" onClick={increment}>+</span></span>
            </div>
          ...
          <li>
            <div className="cartListImg">
              <img src="https://rukminim1.flixcart.com/flap/64/64/image/22fddf3c7da4c4f4.png?q=100" alt="Redmi10"/>
              <span className="productQuantity"><span className="increment">-</span><span className="quantity">0</span><span className="increment">+</span></span>
            </div>
            <div className="cartListDetails">
              <p>Redmi10</p>
              <p>Mobile</p>
